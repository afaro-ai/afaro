...
Seven step types exist. A manifest lists them in order under `steps`. Nothing else is executable: a manifest is data, and this file is the only place that says what the data means.
